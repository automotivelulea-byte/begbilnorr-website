...
export const metadata: Metadata = {
  title: 'Begbilnorr - Begagnade Bilar i Norrbotten',
  description: 'Köp kvalitetsgranskade begagnade bilar i Norrbotten. Stort urval av bilar med garanti.',
  keywords: 'begagnade bilar, bil Norrbotten, bilhandlare, köp bil, sälj bil',
};
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="hidden sm:flex items-center text-gray-700 hover:text-primary-600"
            >
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Begbilnorr</h3>
            <p className="text-gray-400">
              Din pålitliga bilhandlare i Norrbotten. Vi erbjuder kvalitetsgranskade begagnade bilar med garanti.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} Begbilnorr. Alla rättigheter förbehållna.</p>
        </div>
      </div>
    </footer>
  );
